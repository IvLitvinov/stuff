...
<xsl:stylesheet version="3.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cnt="urn:oasis:names:tc:opendocument:xmlns:container" xmlns:opf="http://www.idpf.org/2007/opf" xmlns:ncx="http://www.daisy.org/z3986/2005/ncx/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:altovaext="http://www.altova.com/xslt-extensions">
	...
	<xsl:function name="altovaext:expand-epub-uri">
		...
		<xsl:value-of select="concat(  if ( contains($epub-uri, '%7Czip') ) then substring-before($epub-uri, '%7Czip') else $epub-uri, '%7Czip/', $relative-uri )"/>
	</xsl:function>
